from sqlalchemy import Column, Integer, String, Date, Time, Float, ForeignKey, Enum as SQLEnum, TIMESTAMP, Text, CHAR
...
class Client(Base):
    ...
    registered = relationship("Registered", back_populates="client")
...
class Group(Base):
    ...
    registered = relationship("Registered", back_populates="group")
...
class Registered(Base):
    ...
    group = relationship("Group", back_populates="registered")
    client = relationship("Client", back_populates="registered")
